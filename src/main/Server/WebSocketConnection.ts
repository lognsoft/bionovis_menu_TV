...
function GetAllCamsRoute(route:string) {
    ...
    routeMapHashTable[`streams-preparations`] = streamsPreparations;
    routeMapHashTable[`streams-upstreams`] = streamsUpstreams;
    routeMapHashTable[`streams-downstreams`] = streamsDownStreams;
    routeMapHashTable[`streams-area-passagem`] = streamsAreaPassagem;
    routeMapHashTable[`streams-fill-and-finish`] = streamsFillAndFinish;
...
export { GetAllCamsRoute, WebsocketRun };